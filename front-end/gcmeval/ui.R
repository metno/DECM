            ...
            dashboardBody(
              fluidPage(theme = "bootstrap.css",
                  fluidRow(column(12, box(title = "Disclaimer", status = 'info', collapsible = TRUE, collapsed = FALSE, width = '100%',
                           ...
                           column(6,
                              box(title = "1. Select a region",status = 'primary', width='60%', height=300,
                                  collapsible = FALSE, collapsed = FALSE,
                                         selectInput("region", label = "", width='75%', 
                                              choices = c("Global",
                                                          ...
                                                          "West Indian Ocean")),
                                  plotOutput("map", width = '100%', height = 250))
                           ),
                           column(6,
                                  box(title = "2. Select a time frame and scenario",status = 'primary', width='60%', height=300,
                                      selectInput("season",
                                                  label = "Season",
                           ...
                           column(12, 
                              box(title = '3. Scatterplot of the regional mean climate change', 
                           ...
                           column(12,
                              box(title = '4. Mean annual temperature cycle', width = '100%', 
                           ...
                           column(12,
                                  box(title = '5. Mean annual precipitation cycle', width = '100%', 
                                      status = 'primary', # textOutput("title1")
                                      collapsible = TRUE, collapsed = TRUE, 
                           ...
                           column(12, 
                                  box(title = '6. Table of climate model performance statistics', width = '100%' , status = 'primary',
                                      collapsible = TRUE, collapsed = TRUE,
